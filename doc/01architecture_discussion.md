...
- 対象ストアの候補は Amazon、BOOK☆WALKER、DMM、O'Reilly。対応順は未決定。
...
| 書籍情報の補完 | 紹介文・あらすじ・カテゴリ・公開目次などを収集する | DBの書籍情報と公開ページ → DBの補足情報・出典 |
...
- 購入済み一覧だけでは不足する推薦材料を、公開の商品ページ・出版社ページなどから補う。
- 購入した商品のページを優先し、不足分を他の情報源で補完する案とする。
